...
namespace Phoenix.CrossCutting.DateTimeLibrary.NspiraTime
{
    ...
    /// <summary>
    /// A <see cref="NspiraTime.LocalDateTime" /> in a specific time zone and with a particular offset to distinguish
    ...
    public readonly struct ZonedDateTime : IEquatable<ZonedDateTime>, IFormattable, IXmlSerializable
    {
        ...
        /// <remarks>
        /// The returned
        /// <see cref="NspiraTime.LocalDateTime"/> will have the same calendar system and return the same values for
        ...
        /// <summary>
        /// Gets the week day of this zoned date and time expressed as an <see cref="IsoDayOfWeek"/> value.
        /// </summary>
        ...
        /// <see cref="NspiraTime.LocalDateTime" /> to a <see cref="ZonedDateTime"/>; the <c>ZonedDateTime</c> remembers
