...
namespace Phoenix.CrossCutting.DateTimeLibrary.NspiraTime
{
    ...
    public readonly struct LocalDate : IEquatable<LocalDate>, IComparable<LocalDate>, IComparable, IFormattable, IXmlSerializable
    {
        ...
        /// <summary>
        /// Gets the week day of this local date expressed as an <see cref="IsoDayOfWeek"/> value.
        /// </summary>
        ...
        /// </summary>
        /// <remarks>
        /// This is simply a convenience operator for calling <see cref="Period.Between(Phoenix.CrossCutting.DateTimeLibrary.NspiraTime.LocalDate,Phoenix.CrossCutting.DateTimeLibrary.NspiraTime.LocalDate)"/>.
        ...
        /// </summary>
        /// <remarks>
        /// This is simply a convenience method for calling <see cref="Period.Between(Phoenix.CrossCutting.DateTimeLibrary.NspiraTime.LocalDate,Phoenix.CrossCutting.DateTimeLibrary.NspiraTime.LocalDate)"/>.
