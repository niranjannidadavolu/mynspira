...
using Phoenix.CrossCutting.Security.PhoenixCryptography.Check.CRC.Abstraction;

namespace Phoenix.CrossCutting.Security.PhoenixCryptography.Check.CRC.Implement
{
    /// <summary>
    /// CRC32
    /// </summary>
