...
@Component({
  selector: 'app-paternity-leave',
  templateUrl: './paternity-leave.component.html',
  styleUrls: ['./paternity-leave.component.scss']
})
export class PaternityLeaveComponent implements OnInit {
