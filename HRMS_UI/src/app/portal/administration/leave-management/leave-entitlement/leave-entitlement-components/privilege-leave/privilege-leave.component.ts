...
@Component({
  selector: 'app-privilege-leave',
  templateUrl: './privilege-leave.component.html',
  styleUrls: ['./privilege-leave.component.scss']
})
export class PrivilegeLeaveComponent implements OnInit {
