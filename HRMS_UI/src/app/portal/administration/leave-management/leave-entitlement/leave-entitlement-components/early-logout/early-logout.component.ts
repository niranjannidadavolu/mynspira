...
@Component({
  selector: 'app-early-logout',
  templateUrl: './early-logout.component.html',
  styleUrls: ['./early-logout.component.scss']
})
export class EarlyLogoutComponent implements OnInit {
