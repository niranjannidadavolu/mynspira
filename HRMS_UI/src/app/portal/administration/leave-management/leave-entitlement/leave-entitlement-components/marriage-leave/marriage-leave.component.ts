...
@Component({
  selector: 'app-marriage-leave',
  templateUrl: './marriage-leave.component.html',
  styleUrls: ['./marriage-leave.component.scss']
})
export class MarriageLeaveComponent implements OnInit {
