...
@Component({
  selector: 'app-winter-vacation',
  templateUrl: './winter-vacation.component.html',
  styleUrls: ['./winter-vacation.component.scss']
})
export class WinterVacationComponent implements OnInit {
