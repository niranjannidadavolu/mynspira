...
@Component({
  selector: 'app-special-sick-leave',
  templateUrl: './special-sick-leave.component.html',
  styleUrls: ['./special-sick-leave.component.scss']
})
export class SpecialSickLeaveComponent implements OnInit {
