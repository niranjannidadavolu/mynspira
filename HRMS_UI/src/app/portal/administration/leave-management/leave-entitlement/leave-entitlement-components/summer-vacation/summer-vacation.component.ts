...
@Component({
  selector: 'app-summer-vacation',
  templateUrl: './summer-vacation.component.html',
  styleUrls: ['./summer-vacation.component.scss']
})
export class SummerVacationComponent implements OnInit {
