...
@Component({
  selector: 'app-bereavement-leave',
  templateUrl: './bereavement-leave.component.html',
  styleUrls: ['./bereavement-leave.component.scss']
})
export class BereavementLeaveComponent implements OnInit {
