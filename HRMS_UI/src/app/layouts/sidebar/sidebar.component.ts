...
export class SidebarComponent implements OnInit {
  ...
  constructor(private router: Router,
    ...
    this.dataService.getUserCount().subscribe(data => {
      this.VisitoCount = data;
    });
    this.showVistorCount = false;
  }
  ...
  ngOnInit(): void {
    ...
    if (loggedInUserData) {
      ...
      if (user.EmployeeId == "NSP7003007") {
        this.showVistorCount = true;
      }
      this.menuItems = user.MappedScreens;
    }
  }
